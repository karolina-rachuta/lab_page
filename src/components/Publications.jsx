        ...
        <div className="container">
          ...
          <div className="publications">
            ...
            <div className="publications__list">
              {publications.map(({ title, short_description, journal_name, year, volume, pages, authors, url }) => (
                <div className="publication-box">
                    ...
                    <a className='publication__link' href="{url}">More <img className="publication__linkIcon" src={LinkIcon} alt="Link icon" /></a>
                </div>
              ))}
            </div>
          </div>
